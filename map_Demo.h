#ifndef __MAP_DEMO_H__
#define __MAP_DEMO_H__
...
private:
	typedef rb_tree_demo < key_type, value_type,
...
public:
	...
	typedef typename rep_type::differnce_type difference_type;
	map() :t(Compare()){}
	...
	{
		return t.insert_unique(positon, x);
	}
	template<class InputIterator>
